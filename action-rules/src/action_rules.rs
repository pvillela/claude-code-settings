...
// surface: [`Target::is_file_pattern_ignored`] is the standing example, and the
// `POLICY:` comment below names it as the thing to add. Dead-code analysis has
// nothing useful to say about a specification of that shape.
#![allow(dead_code)]
